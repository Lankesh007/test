...
class BollyWoodDetailsScreen extends StatefulWidget {
  ...
  @override
  _BollyWoodDetailsScreenState createState() => _BollyWoodDetailsScreenState();
}

class _BollyWoodDetailsScreenState extends State<BollyWoodDetailsScreen> {
